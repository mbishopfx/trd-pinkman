...
import { ArrowLeft, Droplets, Shield, CheckCircle, Star } from 'lucide-react'
...
const features = [
  "Seamless, waterproof plaster finish for wet areas",
  "Modern interpretation of ancient Tadelakt tradition", 
  "Applied continuously across surfaces without joints",
  "Delivers both durability and sophisticated design",
  "Resistant to water, stains, and daily wear",
  "Creates smooth, elegant sculptural environments"
]
...
const process = [
  {
    ...
    description: "Detailed assessment of substrate conditions and waterproofing requirements."
  },
  {
    step: "02", 
    title: "Substrate Preparation",
    description: "Specialized base preparation with waterproofing membrane application."
  },
  {
    step: "03",
    title: "Base Coat Application",
    description: "Initial micro-cement layer applied to create the foundation surface."
  },
  {
    step: "04",
    title: "Build-up Layers",
    description: "Multiple thin coats built up to achieve desired thickness and texture."
  },
  {
    step: "05",
    title: "Sealing & Protection",
    description: "Professional sealing system for maximum water resistance and durability."
  }
]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
            ...
            >
              ...
              <h1 className="text-4xl lg:text-6xl font-display text-neutral-900">
                Micro <span className="italic">Cement</span>
              </h1>

              <p className="text-xl text-neutral-600 leading-relaxed">
                A modern interpretation of the ancient Tadelakt tradition, micro-cement creates seamless, 
                waterproof plaster finishes ideal for wet areas. Applied continuously across showers, 
                bathrooms, walls, and floors, it delivers both durability and design — smooth, elegant, 
                and resistant to water. More than functional, this finish turns utilitarian spaces into 
                sculpted environments of understated luxury.
              </p>
            ...
            >
              <div className="relative h-96 lg:h-[500px] rounded-lg overflow-hidden">
                <Image
                  ...
                  alt="Micro-cement finish example"
                  fill
            ...
            <div className="text-center mb-16">
              ...
              >
                <h2 className="text-3xl lg:text-4xl font-display mb-4 text-neutral-900">
                  Why Choose <span className="italic">Micro-Cement</span>
                </h2>
                <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
                  Modern durability meets ancient artistry in seamless waterproof finishes
                </p>
              </motion.div>
            </div>
                ...
                <Card className="h-full bg-white">
                  <CardHeader>
                    <CardTitle className="text-xl font-display text-neutral-900 mb-4 flex items-center">
                      <Shield className="w-6 h-6 mr-3 text-neutral-600" />
                      Key Features
                    </CardTitle>
                  </CardHeader>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              >
                ...
                <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
                  Precision techniques for seamless, durable, and beautiful finishes
                </p>
              </motion.div>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-display mb-6">
                Transform Your Wet Spaces
              </h2>
              <p className="text-xl mb-8 text-white/90 leading-relaxed">
                Experience the perfect fusion of form and function with our micro-cement finishes. 
                Create seamless, waterproof surfaces that elevate your bathroom, kitchen, or spa into 
