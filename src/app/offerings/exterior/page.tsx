...
import { ArrowLeft, Shield, Sun, CheckCircle, Star } from 'lucide-react'
...
const features = [
  ...
  "Protection against moisture and elements",
...
const process = [
  {
    ...
    description: "Comprehensive evaluation of surface conditions and weather exposure factors."
  },
  {
    step: "02", 
    title: "Surface Preparation",
    description: "Power washing, scraping, sanding, and repairs to ensure optimal paint adherence."
  },
  {
    step: "03",
    title: "Priming & Protection",
    description: "Application of high-quality primer systems for maximum durability and coverage."
  },
  {
    step: "04",
    title: "Finish Application",
    description: "Expert application of premium exterior coatings using professional techniques."
  },
  {
    step: "05",
    title: "Final Inspection",
    description: "Thorough quality check and cleanup to ensure long-lasting beautiful results."
  }
]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
            ...
            >
              ...
              <h1 className="text-4xl lg:text-6xl font-display text-neutral-900">
                Exterior <span className="italic">Painting</span>
              </h1>

              <p className="text-xl text-neutral-600 leading-relaxed">
                Protecting and beautifying your home's exterior with durable finishes designed to 
                withstand the elements. Our team delivers expert exterior painting services using 
                premium weather-resistant coatings that provide lasting protection and enhanced curb 
                appeal. More than just paint, our exterior coatings are the first line of defense 
                against weather, UV rays, and time — applied with precision for enduring beauty.
              </p>
            ...
            <div className="text-center mb-16">
              ...
              >
                <h2 className="text-3xl lg:text-4xl font-display mb-4 text-neutral-900">
                  Why Choose Our <span className="italic">Exterior Services</span>
                </h2>
                <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
                  Weather-resistant protection meets beautiful aesthetics for lasting curb appeal
                </p>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <Card className="h-full bg-white">
                  <CardHeader>
                    <CardTitle className="text-xl font-display text-neutral-900 mb-4 flex items-center">
                      <Sun className="w-6 h-6 mr-3 text-neutral-600" />
                      Perfect For
                    </CardTitle>
                  </CardHeader>
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              >
                <h2 className="text-3xl lg:text-4xl font-display mb-4 text-neutral-900">
                  Exterior <span className="italic">Process</span>
                </h2>
                <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
                  Comprehensive approach to long-lasting exterior protection and beauty
                </p>
              </motion.div>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 text-white/90 leading-relaxed">
                Give your home the protection it deserves with our expert exterior painting services. 
                Our premium coatings and professional application ensure your investment is protected 
                for years to come while enhancing your property's curb appeal.
              </p>
